...
class PyFiBotFactory(ThrottledClientFactory):
    ...
    def save_config(self):
        config_path = os.path.join(sys.path[0], "bot.config")
    ...
    def buildProtocol(self, address):
        ...
        #print self.config
        if not self.config.has_key('cmdchar'):
            print "Defaulting to . for cmdchar."
            cmdchar = '.'
        else:
...
if __name__ == '__main__':
    ...
    # This is a kludge to get around a bug in OSX 10.6
    # If you use strptime outside of the main thread it'll core
